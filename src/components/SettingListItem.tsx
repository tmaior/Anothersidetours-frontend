...
export default function SettingListItem({ title, description, icon }) {
    return (
        <Flex align="center" borderBottom="1px solid" borderColor="gray.200" height="150px" sx={{ cursor: "pointer" }} justifyContent="center" width="100%" backgroundColor={title === "My Profile" ? "#d1e1ff": 'white' }>
